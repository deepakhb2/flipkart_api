...
== Usage
 ...
 rest_url = fa.get_category_porducts_api(category_name) #Name is as present in the categories
 ...
 products = fa.get_all_products(rest_url) #Url is the one retured by get_categories/get_category_products_api. This method will get all the products in JSON parsed data structure

 products = fa.get_products(rest_url) #Url is the one returned by get_categories/get_category_products_api. Returns upto 500 products from the given rest api in JSON parsed data structure
